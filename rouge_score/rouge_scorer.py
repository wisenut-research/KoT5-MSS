...
class RougeScorer(scoring.BaseScorer):
  ...
  """
    ...
    """
        ...
        self.REMOVE_CHAR_PATTERN = re.compile("[^A-Za-z0-9가-힣]")
        ####
    ...
    """
        ...
        target = self.REMOVE_CHAR_PATTERN.sub(" ", target.lower()).strip()
        prediction = self.REMOVE_CHAR_PATTERN.sub(" ", prediction.lower()).strip()
